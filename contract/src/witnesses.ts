...
import { Ledger } from "./managed/rock_paper_scissors/contract/index.cjs";
...
export type RockPaperScissorsPrivateState = {
  readonly localGameSecretKey: Uint8Array;
};

export const createRockPaperScissorsPrivateState = (localGameSecretKey: Uint8Array) => ({
  localGameSecretKey,
});
...
export const witnesses = {
  localGameSecretKey: ({
    privateState, 
  }: WitnessContext<Ledger, RockPaperScissorsPrivateState>): [
    RockPaperScissorsPrivateState,
    Uint8Array,
  ] => [privateState, privateState.localGameSecretKey],
};
